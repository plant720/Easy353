...
from src.build_database import generate_fasta_path, download_dict, generate_gene_file
...
def main_window():
    ...
    advanced_para_frame = [
        # sliding_window
        [sg.Text('Step_length', size=(14, 1), justification='center', font=("Times", 12)),
         sg.Input(1, key='-s-', size=(12, 1), font=("Times", 12), expand_x=True,
                  background_color='#BFE9FF',
                  tooltip="Step length of the sliding window on the reads. [Default:1]"
                  ),
         sg.Text('Ref_ratio', size=(14, 1), justification='center', font=("Times", 12)),
        ...
        [sg.Text('Change_seed', size=(14, 1), justification='center', font=("Times", 12)),
         sg.Input(32, key='-change_seed-', size=(12, 1), font=("Times", 12), expand_x=True,
                  background_color='#BFE9FF',
                  tooltip="Times of changing seed. [Default:32]"),

         sg.Text('Kmer_limit', size=(14, 1), justification='center', font=("Times", 12)),
        ...
        [sg.Text('Min_length_ratio', size=(14, 1), justification='center', font=("Times", 12)),
         ...
         sg.Text('Max_length_ratio', size=(14, 1), justification='center', font=("Times", 12)),
        ...
        # reverse_complement
        [sg.Text('Ref_reverse_complement', size=(21, 1), justification='center', font=("Times", 12)),
         sg.Checkbox(text="True", default=True,
                     key='-reverse_complement-', size=(12, 1), font=("Times", 12), ),

         sg.Text('Generate_scaffold', size=(15, 1), justification='center', font=("Times", 12)),
    ...
    while True:
        ...
        if event == 'Run' and not running_flag:
            ...
            if classification is not None:
                ...
                # 检测已经存在的文件名
                existed_files = [i.split("/")[1] for i in generate_fasta_path(output_dir)]
                # 获取还未下载的文件
                ...
                for _spec_info_ in down_spec_info:
                    print("Download files: {} / {} {}%".format(count, len(down_spec_info),
                                                               int(count / len(down_spec_info) * 100)))
                    download_dict(_spec_info_, output_dir)
                    count += 1
            ...
            filter_flow(_read_data_tuple_=fastq_files, _out_dir_=filter_out,
            ...
            assemble_flow(_input_read_path_=filter_out, _out_dir_=assemble_out, _ref_path_=reference,
